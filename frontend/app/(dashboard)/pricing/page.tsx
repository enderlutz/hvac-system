    ...
    <div className="space-y-10 max-w-6xl">
      ...
      <section>
        <SectionHeading
          ...
          subtitle="Items that need client confirmation before pricing is finalized"
        />

        <div className="space-y-3">
          <CalloutBox type="warning">
            <p className="font-semibold mb-1">Tier Strategy Not Confirmed</p>
            <p>
              The client has not confirmed whether proposals should use brand-based tiers (Good = Goodman, Better = Amana, Best = Trane)
              or efficiency-based tiers (all Amana, tiered by SEER2). Currently defaulting to brand-based.
              Both strategies are implemented and can be switched with a single config change.
            </p>
          </CalloutBox>

          <CalloutBox type="warning">
            <p className="font-semibold mb-1">Adder Costs: Lineset, Electrical, Ductwork</p>
            <p>
              The cost amounts for lineset replacement, electrical work, and ductwork modifications are not yet set.
              These adders are toggled on/off per job but their dollar values need client confirmation.
              Currently set to <code className="bg-amber-100 px-1 rounded text-xs">null</code> in the pricebook
              and will show as &quot;TBD&quot; in proposals.
            </p>
          </CalloutBox>

          <CalloutBox type="warning">
            <p className="font-semibold mb-1">Materials Buffer Factor (x1.05)</p>
            <p>
              The Excel applies a 1.05 multiplier to materials. This appears to be a waste/handling buffer,
              but the client has not confirmed whether it represents waste allowance, handling fees, or something else.
              The engine applies it as-is to match the Excel output.
            </p>
          </CalloutBox>

          <CalloutBox type="warning">
            <p className="font-semibold mb-1">Incentive (4% of Sale)</p>
            <p>
              The Excel workbook references an &quot;Incentive&quot; line calculated as 4% of the sale price.
              It is unclear if this is a salesperson commission, a customer rebate, or a distributor kickback.
              Currently <strong>not included</strong> in the pricing engine. Needs client clarification.
            </p>
          </CalloutBox>

          <CalloutBox type="info">
            <p className="font-semibold mb-1">Trane Premium Furnace Cost</p>
            <p>
              The S9V2C100U5VSB (Trane 100k BTU variable furnace) is listed at $3,965 in the Excel workbook.
              This is significantly higher than the 80k BTU variant ($1,982). The cost has been entered as-is
              but should be verified with the distributor.
            </p>
          </CalloutBox>
        </div>
      </section>

      {/* ── Section 6: Texas Compliance ──────────────────────────────────── */}
      <section>
        <SectionHeading
          icon={Shield}
          title="Texas Compliance"
          subtitle="Regulatory requirements for HVAC systems in the Houston metro area"
        />

        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card>
            <CardContent className="p-4 flex items-start gap-3">
              <Thermometer className="h-5 w-5 text-red-500 shrink-0 mt-0.5" />
              <div>
                <div className="font-semibold text-sm text-gray-900">SEER2 Minimum: 15</div>
                <p className="text-xs text-gray-500 mt-1">
                  As of January 2023, all residential AC systems installed in Texas
                  (South region) must meet a minimum 15 SEER2 rating. All &quot;Good&quot; tier
          ...
          <Card>
            <CardContent className="p-4 flex items-start gap-3">
              ...
              <div>
                <div className="font-semibold text-sm text-gray-900">Sales Tax: 8.25%</div>
                <p className="text-xs text-gray-500 mt-1">
                  Texas state (6.25%) plus Harris County local (2%) sales tax.
                  Applied to equipment and taxable materials. Labor is exempt.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-4 flex items-start gap-3">
              ...
              <div>
                <div className="font-semibold text-sm text-gray-900">Permits Required</div>
                <p className="text-xs text-gray-500 mt-1">
                  City of Houston requires mechanical permits for HVAC replacements.
                  Cost calculated as 2% of equipment valuation + $79.45 base fee.
                  License: TACLA29424E.
                </p>
              </div>
            </CardContent>
